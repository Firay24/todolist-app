    ...
    <div className="relative inline-block text-left">
      <div>
        <button
          ...
          type="button"
          className="flex items-center justify-between w-1/4 px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-100 focus:ring-indigo-500"
          id="options-menu"
          aria-haspopup="true"
